...
for index, row in df.iterrows():
    ...
    if checked != "true":
        ...
        try:           
            ...
            store_names = [store.get_text() for store in page_soup.find_all('div', class_='fontHeadlineSmall')]

            # Encuentra las direcciones
            address_elements = page_soup.find_all('div', class_='section-subtitle-extension')
            addresses = []
