...
def main():
    ...
    # open Excel file
    file_path = r".\search_parameters.csv"
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            # Find names of items, on google maps use to be in the variable main_class
            store_elements = driver.find_elements(By.CLASS_NAME, main_class)
            store_names = []
            alt_texts = []
            hrefs = []
